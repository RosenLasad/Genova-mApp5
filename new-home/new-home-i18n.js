...
(function(){
  ...
  var rows = [
    ...
    ['Cerca in Genova mApp','Search Genova mApp','Buscar en Genova mApp','Rechercher dans Genova mApp','ابحث في Genova mApp','Поиск в Genova mApp','搜索 Genova mApp','Çerca in Genova mApp'],
    ['Cerca luoghi, trasporti, percorsi e contenuti','Search places, transport, routes and content','Busca lugares, transportes, rutas y contenidos','Recherchez des lieux, transports, itinéraires et contenus','ابحث عن أماكن ووسائل نقل ومسارات ومحتوى','Ищите места, транспорт, маршруты и материалы','搜索地点、交通、路线和内容','Çerca leughi, trasporti, percorsi e contegnui'],
    ['Risultati','Results','Resultados','Résultats','النتائج','Результаты','结果','Risultati'],
    ['Scrivi almeno 2 caratteri','Type at least 2 characters','Escribe al menos 2 caracteres','Saisissez au moins 2 caractères','اكتب حرفين على الأقل','Введите не менее 2 символов','请至少输入2个字符','Scrivi almeno 2 caratteri'],
    ['Ricerca globale','Global search','Búsqueda global','Recherche globale','البحث الشامل','Глобальный поиск','全局搜索','Riçerca globale'],
    ['Nella New Home puoi usare la ricerca globale per trovare rapidamente luoghi, trasporti, percorsi, punti QR e altri contenuti senza aprire prima una categoria.','In the New Home you can use global search to quickly find places, transport, routes, QR points and other content without opening a category first.','En la New Home puedes utilizar la búsqueda global para encontrar rápidamente lugares, transportes, rutas, puntos QR y otros contenidos sin tener que abrir primero una categoría.','Dans la New Home, vous pouvez utiliser la recherche globale pour trouver rapidement des lieux, des transports, des itinéraires, des points QR et d’autres contenus sans ouvrir d’abord une catégorie.','في New Home يمكنك استخدام البحث الشامل للعثور بسرعة على الأماكن ووسائل النقل والمسارات ونقاط QR والمحتويات الأخرى من دون فتح فئة أولاً.','В New Home можно использовать глобальный поиск, чтобы быстро находить места, транспорт, маршруты, QR-точки и другие материалы, не открывая сначала категорию.','在 New Home 中，您可以使用全局搜索快速查找地点、交通、路线、QR 点和其他内容，无需先打开某个分类。','Inte New Home ti peu adêuviâ a riçerca globale pe trovâ fito leughi, trasporti, percorsi, ponti QR e atri contegnui sensa doive arvî primma unna categoria.'],
    ['Digita almeno due caratteri e seleziona un risultato per aprire direttamente il contenuto o la sezione corrispondente.','Type at least two characters and select a result to open the corresponding content or section directly.','Escribe al menos dos caracteres y selecciona un resultado para abrir directamente el contenido o la sección correspondiente.','Saisissez au moins deux caractères et sélectionnez un résultat pour ouvrir directement le contenu ou la section correspondante.','اكتب حرفين على الأقل ثم اختر نتيجة لفتح المحتوى أو القسم المقابل مباشرة.','Введите не менее двух символов и выберите результат, чтобы сразу открыть соответствующий материал или раздел.','输入至少两个字符，然后选择结果即可直接打开相应内容或版块。','Scrivi almeno doi caratteri e seleçionn-a un risultato pe arvî direttamente o contegnuo ò a seçion corrispondente.'],
    ...
    ['Trasporto pubblico e collegamenti','Public transport and connections','Transporte público y conexiones','Transports publics et liaisons','النقل العام والروابط','Общественный транспорт и сообщения','公共交通与连接','Trasporti pubbrichi e collegamenti'],
    ['Noleggi','Rentals','Alquileres','Locations','خدمات التأجير','Аренда','租赁服务','Nolezzi'],
    ['Noleggio auto','Car rental','Alquiler de coches','Location de voitures','تأجير السيارات','Аренда автомобилей','汽车租赁','Nolezzo auto'],
    ['Servizi di autonoleggio in città','Car rental services in the city','Servicios de alquiler de coches en la ciudad','Services de location de voitures en ville','خدمات تأجير السيارات في المدينة','Сервисы аренды автомобилей в городе','市内汽车租赁服务','Serviçi de nolezzo auto in çittæ'],
    ['Noleggio moto e scooter','Motorbike and scooter rental','Alquiler de motos y scooters','Location de motos et scooters','تأجير الدراجات النارية والسكوتر','Аренда мотоциклов и скутеров','摩托车和踏板车租赁','Nolezzo moto e scooter'],
    ['Servizi di noleggio per moto e scooter','Motorbike and scooter rental services','Servicios de alquiler de motos y scooters','Services de location de motos et scooters','خدمات تأجير الدراجات النارية والسكوتر','Сервисы аренды мотоциклов и скутеров','摩托车和踏板车租赁服务','Serviçi de nolezzo pe moto e scooter'],
    ['Noleggio bici e bike sharing','Bike rental and bike sharing','Alquiler de bicicletas y bike sharing','Location de vélos et vélos en libre-service','تأجير الدراجات ومشاركة الدراجات','Прокат велосипедов и байкшеринг','自行车租赁与共享单车','Nolezzo biciclette e bike sharing'],
    ['Negozi, bike sharing e servizi con app o QR Code','Shops, bike sharing and app or QR Code services','Tiendas, bike sharing y servicios con app o código QR','Boutiques, vélos en libre-service et services par appli ou QR Code','متاجر ومشاركة الدراجات وخدمات عبر التطبيق أو رمز QR','Пункты проката, байкшеринг и сервисы через приложение или QR-код','门店、共享单车以及通过应用或二维码使用的服务','Negozi, bike sharing e serviçi con app ò QR Code'],
    ['Noleggio imbarcazioni','Boat rental','Alquiler de embarcaciones','Location de bateaux','تأجير القوارب','Аренда лодок','船只租赁','Nolezzo barche'],
    ['Noleggio barche e servizi nautici','Boat rental and nautical services','Alquiler de barcos y servicios náuticos','Location de bateaux et services nautiques','تأجير القوارب والخدمات البحرية','Аренда лодок и морские услуги','船只租赁与航海服务','Nolezzo barche e serviçi nautichi'],
    ['Trasporti, collegamenti e servizi per spostarsi a Genova e sul territorio.','Transport, connections and services for getting around Genoa and the surrounding area.','Transportes, conexiones y servicios para moverse por Génova y sus alrededores.','Transports, liaisons et services pour se déplacer à Gênes et dans ses environs.','وسائل النقل والروابط والخدمات للتنقل في جنوة ومحيطها.','Транспорт, сообщения и сервисы для передвижения по Генуе и окрестностям.','热那亚及周边地区的交通、连接与出行服务。','Trasporti, collegamenti e serviçi pe mesciâse a Zena e into territöio.'],
    ...
    ['Cerca nell\'elenco','Search the list','Buscar en la lista','Rechercher dans la liste','ابحث في القائمة','Поиск по списку','搜索列表','Çerca inta lista'],
    ['Cerca una linea, una fermata o una destinazione','Search for a route, stop or destination','Busca una línea, una parada o un destino','Rechercher une ligne, un arrêt ou une destination','ابحث عن خط أو محطة أو وجهة','Найти маршрут, остановку или пункт назначения','搜索线路、站点或目的地','Çerca unna linia, unna fermâ ò unna destinaçion'],
    ['Cerca una stazione o una fermata','Search for a station or stop','Busca una estación o una parada','Rechercher une station ou un arrêt','ابحث عن محطة أو موقف','Найти станцию или остановку','搜索车站或站点','Çerca unna staçion ò unna fermâ'],
    ['Cerca una stazione','Search for a station','Busca una estación','Rechercher une gare','ابحث عن محطة','Найти станцию','搜索车站','Çerca unna staçion'],
    ['Cerca un impianto o una fermata','Search for a system or stop','Busca una instalación o una parada','Rechercher une installation ou un arrêt','ابحث عن مرفق أو محطة','Найти подъёмник или остановку','搜索设施或站点','Çerca un impianto ò unna fermâ'],
    ['Cerca una linea, un approdo o una destinazione','Search for a route, landing or destination','Busca una línea, un embarcadero o un destino','Rechercher une ligne, un embarcadère ou une destination','ابحث عن خط أو مرسى أو وجهة','Найти маршрут, причал или пункт назначения','搜索线路、码头或目的地','Çerca unna linia, un approdo ò unna destinaçion'],
    ['Cerca un collegamento o una destinazione','Search for a connection or destination','Busca una conexión o un destino','Rechercher une liaison ou une destination','ابحث عن رحلة ربط أو وجهة','Найти рейс или пункт назначения','搜索航线或目的地','Çerca un collegamento ò unna destinaçion'],
    ['Nessun risultato trovato.','No results found.','No se encontraron resultados.','Aucun résultat trouvé.','لم يتم العثور على نتائج.','Результаты не найдены.','未找到结果。','Nisciun risultato trovou.'],
    ...
    ['Accedi o registrati a Genova mApp per utilizzare Cerca eventi. L’Account gratuito dispone di 5 ricerche ogni 24 ore; Premium di 30.','Log in or sign up for Genova mApp to use Search events. A free account includes 5 searches every 24 hours; Premium includes 30.','Inicia sesión o regístrate en Genova mApp para usar Buscar eventos. La cuenta gratuita incluye 5 búsquedas cada 24 horas; Premium incluye 30.','Connectez-vous ou inscrivez-vous à Genova mApp pour utiliser la recherche d’événements. Le compte gratuit comprend 5 recherches toutes les 24 heures ; Premium en comprend 30.','سجّل الدخول أو أنشئ حساباً في Genova mApp لاستخدام البحث عن الفعاليات. يتيح الحساب المجاني 5 عمليات بحث كل 24 ساعة، وPremium يتيح 30.','Войдите или зарегистрируйтесь в Genova mApp, чтобы пользоваться поиском событий. Бесплатному аккаунту доступно 5 поисков каждые 24 часа, Premium — 30.','登录或注册 Genova mApp 后即可使用活动搜索。免费账号每24小时可搜索5次，Premium可搜索30次。','Intra ò registrite a Genova mApp pe adêuviâ Çerca eventi. L’Account gratuito o l’à 5 riçerche ògni 24 oe; Premium 30.'],
    ...
    ['Hai raggiunto il limite di {0} ricerche nelle ultime 24 ore.','You have reached the limit of {0} searches in the last 24 hours.','Has alcanzado el límite de {0} búsquedas en las últimas 24 horas.','Vous avez atteint la limite de {0} recherches au cours des dernières 24 heures.','لقد وصلت إلى حد {0} عمليات بحث خلال آخر 24 ساعة.','Вы достигли лимита в {0} поисков за последние 24 часа.','您已达到过去24小时内{0}次搜索的上限。','Ti t’æ raggiunto o limite de {0} riçerche inte urtime 24 oe.'],
  ...
  [
    ...
    "Alquiler de coches — Próximamente.",
    "Location de voitures — Bientôt disponible.",
    "تأجير السيارات — قريباً.",
    "Аренда автомобилей — Скоро.",
    "汽车租赁 — 即将推出。",
    "Nolezzo auto — In arrivo."
  ],
  [
    "Noleggio moto e scooter — In arrivo.",
    "Motorbike and scooter rental — Coming soon.",
    "Alquiler de motos y scooters — Próximamente.",
    "Location de motos et scooters — Bientôt disponible.",
    "تأجير الدراجات النارية والسكوتر — قريباً.",
    "Аренда мотоциклов и скутеров — Скоро.",
    "摩托车和踏板车租赁 — 即将推出。",
    "Nolezzo moto e scooter — In arrivo."
  ],
  [
    "Noleggio bici e bike sharing — In arrivo.",
    "Bike rental and bike sharing — Coming soon.",
    "Alquiler de bicicletas y bike sharing — Próximamente.",
    "Location de vélos et vélos en libre-service — Bientôt disponible.",
    "تأجير الدراجات ومشاركة الدراجات — قريباً.",
    "Прокат велосипедов и байкшеринг — Скоро.",
    "自行车租赁与共享单车 — 即将推出。",
    "Nolezzo biciclette e bike sharing — In arrivo."
  ],
  [
    "Noleggio imbarcazioni — In arrivo.",
    "Boat rental — Coming soon.",
    "Alquiler de embarcaciones — Próximamente.",
    "Location de bateaux — Bientôt disponible.",
    "تأجير القوارب — قريباً.",
    "Аренда лодок — Скоро.",
    "船只租赁 — 即将推出。",
    "Nolezzo barche — In arrivo."
  ],
  [
    ...
    "The rental options are already prepared and will be activated progressively as the relevant services become available.",
    "Las opciones de alquiler ya están preparadas y se activarán progresivamente cuando estén disponibles los servicios correspondientes.",
    "Les options de location sont déjà prévues et seront activées progressivement à mesure que les services correspondants seront disponibles.",
    "خيارات التأجير مجهزة بالفعل وسيتم تفعيلها تدريجياً عند توفر الخدمات المعنية.",
    "Разделы аренды уже предусмотрены и будут постепенно активироваться по мере появления соответствующих услуг.",
    "租赁相关选项已预先设置，将在相应服务可用后逐步启用。",
    "E voxe dedicate a-i nolezzi son za predisposte e saian ativæ pöco a-a vòtta quande i serviçi saian disponibili."
  ],
  [
    "Premi — iniziative, obiettivi e vantaggi disponibili per gli utenti. In arrivo.",
    "Rewards — initiatives, goals and benefits available to users. Coming soon.",
    "Premios — iniciativas, objetivos y ventajas disponibles para los usuarios. Próximamente.",
    "Récompenses — initiatives, objectifs et avantages proposés aux utilisateurs. Bientôt disponible.",
    "الجوائز — مبادرات وأهداف ومزايا متاحة للمستخدمين. قريباً.",
    "Призы — инициативы, цели и преимущества для пользователей. Скоро.",
    "奖励 — 面向用户的活动、目标与福利。即将推出。",
    "Premi — iniçiative, obiettivi e vantaggi pe-i utenti. In arrivo."
  ],
  [
    "Shop — prodotti e contenuti legati a Genova e a Genova mApp. In arrivo.",
    "Shop — products and content related to Genoa and Genova mApp. Coming soon.",
    "Tienda — productos y contenidos relacionados con Génova y Genova mApp. Próximamente.",
    "Boutique — produits et contenus liés à Gênes et à Genova mApp. Bientôt disponible.",
    "المتجر — منتجات ومحتويات مرتبطة بجنوة وGenova mApp. قريباً.",
    "Магазин — товары и материалы, связанные с Генуей и Genova mApp. Скоро.",
    "商店 — 与热那亚和 Genova mApp 相关的商品与内容。即将推出。",
    "Shop — prodotti e contegnui ligæ a Zena e a Genova mApp. In arrivo."
  ],
  [
