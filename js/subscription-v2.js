/* Genova mApp - pannello Abbonamento, account Netlify + Stripe + coupon. */
(function(){
  'use strict';
  ...
  var C={
    it:{
      ...
      guestFeatures:['Cerca Eventi richiede un account','GPS disponibile, senza Raggio/Vicino a me','Note conservate solo su questo dispositivo','Anteprima MiniDoc di 10 secondi','Nessun punto Preferito e nessun Percorso personalizzato'],
      freeFeatures:['5 ricerche Eventi ogni 24 ore','GPS + Raggio/Vicino a me','Preferiti, percorsi e note sincronizzati','Fino a 10 punti Preferiti sulla mappa','1 Percorso personalizzato','Anteprima MiniDoc di 10 secondi'],
      premiumFeatures:['30 ricerche Eventi ogni 24 ore','GPS + Raggio/Vicino a me','Preferiti, percorsi e note sincronizzati','Punti Preferiti illimitati','Percorsi personalizzati illimitati','MiniDoc completi'],
      ...
      checkoutPending:'Il servizio di pagamento non è momentaneamente disponibile. Riprova tra poco.',working:'Apertura del checkout…',error:'Non è stato possibile aprire il checkout. Riprova tra poco.',
      activeTitle:'Il tuo abbonamento Premium è attivo',user:'Utente',plan:'Piano',renewal:'Prossimo rinnovo',accessUntil:'Accesso fino al',managePending:'Il portale di gestione Stripe non è momentaneamente disponibile. Riprova tra poco.',unknown:'—'
    },
    en:{
      ...
      guestFeatures:['Event search requires an account','GPS available, without Radius/Near me','Notes stored only on this device','10-second MiniDoc preview','No Favourite points or custom Routes'],
      freeFeatures:['5 Event searches every 24 hours','GPS + Radius/Near me','Favourites, routes and notes synced','Up to 10 Favourite map points','1 custom Route','10-second MiniDoc preview'],
      premiumFeatures:['30 Event searches every 24 hours','GPS + Radius/Near me','Favourites, routes and notes synced','Unlimited Favourite points','Unlimited custom Routes','Full MiniDocs'],
      ...
      checkoutPending:'The payment service is temporarily unavailable. Please try again shortly.',working:'Opening checkout…',error:'Checkout could not be opened. Please try again shortly.',
      activeTitle:'Your Premium subscription is active',user:'User',plan:'Plan',renewal:'Next renewal',accessUntil:'Access until',managePending:'The Stripe management portal is temporarily unavailable. Please try again shortly.',unknown:'—'
    },
    es:{
      ...
      guestFeatures:['La búsqueda de Eventos requiere una cuenta','GPS disponible, sin Radio/Cerca de mí','Notas guardadas solo en este dispositivo','Vista previa MiniDoc de 10 segundos','Sin puntos Favoritos ni Rutas personalizadas'],
      freeFeatures:['5 búsquedas de Eventos cada 24 horas','GPS + Radio/Cerca de mí','Favoritos, rutas y notas sincronizados','Hasta 10 puntos Favoritos en el mapa','1 Ruta personalizada','Vista previa MiniDoc de 10 segundos'],
      premiumFeatures:['30 búsquedas de Eventos cada 24 horas','GPS + Radio/Cerca de mí','Favoritos, rutas y notas sincronizados','Puntos Favoritos ilimitados','Rutas personalizadas ilimitadas','MiniDoc completos'],
      ...
      checkoutPending:'El servicio de pago no está disponible temporalmente. Vuelve a intentarlo en breve.',working:'Abriendo el pago…',error:'No se pudo abrir el pago. Vuelve a intentarlo en breve.',
      activeTitle:'Tu suscripción Premium está activa',user:'Usuario',plan:'Plan',renewal:'Próxima renovación',accessUntil:'Acceso hasta',managePending:'El portal de gestión de Stripe no está disponible temporalmente. Vuelve a intentarlo en breve.',unknown:'—'
    },
    fr:{
      ...
      guestFeatures:['La recherche d’Événements nécessite un compte','GPS disponible, sans Rayon/À proximité','Notes conservées uniquement sur cet appareil','Aperçu MiniDoc de 10 secondes','Aucun point Favori ni Parcours personnalisé'],
      freeFeatures:['5 recherches Événements toutes les 24 heures','GPS + Rayon/À proximité','Favoris, parcours et notes synchronisés','Jusqu’à 10 points Favoris sur la carte','1 Parcours personnalisé','Aperçu MiniDoc de 10 secondes'],
      premiumFeatures:['30 recherches Événements toutes les 24 heures','GPS + Rayon/À proximité','Favoris, parcours et notes synchronisés','Points Favoris illimités','Parcours personnalisés illimités','MiniDoc complets'],
      ...
      checkoutPending:'Le service de paiement est momentanément indisponible. Réessayez dans quelques instants.',working:'Ouverture du paiement…',error:'Impossible d’ouvrir le paiement. Réessayez dans quelques instants.',
      activeTitle:'Votre abonnement Premium est actif',user:'Utilisateur',plan:'Formule',renewal:'Prochain renouvellement',accessUntil:'Accès jusqu’au',managePending:'Le portail de gestion Stripe est momentanément indisponible. Réessayez dans quelques instants.',unknown:'—'
    },
    ar:{
      ...
      guestFeatures:['البحث عن الفعاليات يتطلب حساباً','GPS متاح من دون النطاق/بالقرب مني','الملاحظات محفوظة على هذا الجهاز فقط','معاينة MiniDoc لمدة 10 ثوانٍ','لا نقاط مفضلة ولا مسارات مخصصة'],
      freeFeatures:['5 عمليات بحث عن الفعاليات كل 24 ساعة','GPS + النطاق/بالقرب مني','مزامنة المفضلة والمسارات والملاحظات','حتى 10 نقاط مفضلة على الخريطة','مسار مخصص واحد','معاينة MiniDoc لمدة 10 ثوانٍ'],
      premiumFeatures:['30 عملية بحث عن الفعاليات كل 24 ساعة','GPS + النطاق/بالقرب مني','مزامنة المفضلة والمسارات والملاحظات','نقاط مفضلة غير محدودة','مسارات مخصصة غير محدودة','MiniDoc كاملة'],
      ...
      checkoutPending:'خدمة الدفع غير متاحة مؤقتاً. حاول مرة أخرى بعد قليل.',working:'جارٍ فتح صفحة الدفع…',error:'تعذر فتح صفحة الدفع. حاول مرة أخرى بعد قليل.',
      activeTitle:'اشتراك Premium الخاص بك نشط',user:'المستخدم',plan:'الخطة',renewal:'التجديد التالي',accessUntil:'الوصول حتى',managePending:'بوابة إدارة Stripe غير متاحة مؤقتاً. حاول مرة أخرى بعد قليل.',unknown:'—'
    },
    ru:{
      ...
      guestFeatures:['Поиск событий требует входа в аккаунт','GPS доступен без Радиуса/Рядом со мной','Заметки хранятся только на этом устройстве','10-секундный просмотр MiniDoc','Без Избранных точек и своих Маршрутов'],
      freeFeatures:['5 поисков событий за 24 часа','GPS + Радиус/Рядом со мной','Синхронизация Избранного, маршрутов и заметок','До 10 Избранных точек на карте','1 собственный Маршрут','10-секундный просмотр MiniDoc'],
      premiumFeatures:['30 поисков событий за 24 часа','GPS + Радиус/Рядом со мной','Синхронизация Избранного, маршрутов и заметок','Неограниченное число Избранных точек','Неограниченное число своих Маршрутов','Полные MiniDoc'],
      ...
      checkoutPending:'Платёжный сервис временно недоступен. Повторите попытку позже.',working:'Открываем оплату…',error:'Не удалось открыть оплату. Повторите попытку позже.',
      activeTitle:'Ваша подписка Premium активна',user:'Пользователь',plan:'План',renewal:'Следующее продление',accessUntil:'Доступ до',managePending:'Портал управления Stripe временно недоступен. Повторите попытку позже.',unknown:'—'
    },
    zh:{
      ...
      guestFeatures:['活动搜索需要登录账号','可使用 GPS，但不能使用半径/附近功能','笔记仅保存在当前设备','MiniDoc 可预览 10 秒','不能收藏地图点或创建自定义路线'],
      freeFeatures:['每 24 小时可搜索 5 次活动','GPS + 半径/附近功能','同步收藏、路线和笔记','最多收藏 10 个地图点','可创建 1 条自定义路线','MiniDoc 可预览 10 秒'],
      premiumFeatures:['每 24 小时可搜索 30 次活动','GPS + 半径/附近功能','同步收藏、路线和笔记','不限量收藏地图点','不限量创建自定义路线','完整观看 MiniDoc'],
      ...
      checkoutPending:'支付服务暂时不可用，请稍后重试。',working:'正在打开结账页面…',error:'无法打开结账页面，请稍后重试。',
      activeTitle:'你的 Premium 订阅已生效',user:'用户',plan:'方案',renewal:'下次续订',accessUntil:'可使用至',managePending:'Stripe 管理门户暂时不可用，请稍后重试。',unknown:'—'
    },
    lij:{
      ...
      guestFeatures:['Çerca Eventi o domanda un account','GPS disponibile, sensa Raggio/Vixin a mi','Nòtte sarvæ solo in sciô dispoxitivo','Anteprimma MiniDoc de 10 secondi','Nisciun ponto Preferio e nisciun Percorso personalizzou'],
      freeFeatures:['5 riçerche Eventi ògni 24 oe','GPS + Raggio/Vixin a mi','Preferii, percorsi e nòtte sincronizzæ','Fìnn-a 10 ponti Preferii in sciâ mappa','1 Percorso personalizzou','Anteprimma MiniDoc de 10 secondi'],
      premiumFeatures:['30 riçerche Eventi ògni 24 oe','GPS + Raggio/Vixin a mi','Preferii, percorsi e nòtte sincronizzæ','Ponti Preferii sensa limite','Percorsi personalizzæ sensa limite','MiniDoc completi'],
      ...
      checkoutPending:'O serviçio de pagamento o no l’é momentaneamente disponibile. Preuva torna tra un pö.',working:'Arvo o checkout…',error:'No semmo riescîi a arvî o checkout. Preuva torna tra un pö.',
      activeTitle:'O teu abonamento Premium o l’é ativo',user:'Utente',plan:'Pian',renewal:'Pròscimo renovo',accessUntil:'Accesso finn-a-o',managePending:'O portâ de gestion Stripe o no l’é momentaneamente disponibile. Preuva torna tra un pö.',unknown:'—'
    }
  };
