(function(){
  ...
  var TEXT = {
    it:  { official:'Sito ufficiale', address:'Indirizzo', service:'Servizio', info:'Informazioni e storia', openInfo:'Apri informazioni', closeInfo:'Chiudi informazioni', imagePending:'Fotografia in preparazione' },
    en:  { official:'Official website', address:'Address', service:'Service', info:'Information and history', openInfo:'Open information', closeInfo:'Close information', imagePending:'Photograph coming soon' },
    es:  { official:'Sitio oficial', address:'Dirección', service:'Servicio', info:'Información e historia', openInfo:'Abrir información', closeInfo:'Cerrar información', imagePending:'Fotografía en preparación' },
    fr:  { official:'Site officiel', address:'Adresse', service:'Service', info:'Informations et histoire', openInfo:'Ouvrir les informations', closeInfo:'Fermer les informations', imagePending:'Photographie à venir' },
    ar:  { official:'الموقع الرسمي', address:'العنوان', service:'الخدمة', info:'معلومات وتاريخ', openInfo:'فتح المعلومات', closeInfo:'إغلاق المعلومات', imagePending:'الصورة قيد الإعداد' },
    ru:  { official:'Официальный сайт', address:'Адрес', service:'Сервис', info:'Информация и история', openInfo:'Открыть информацию', closeInfo:'Закрыть информацию', imagePending:'Фотография готовится' },
    zh:  { official:'官方网站', address:'地址', service:'交通服务', info:'信息与历史', openInfo:'打开信息', closeInfo:'关闭信息', imagePending:'照片准备中' },
    lij: { official:'Sito uffiçiâ', address:'Indirisso', service:'Serviçio', info:'Informaçioin e stöia', openInfo:'Arvi e informaçioin', closeInfo:'Særa e informaçioin', imagePending:'Föto in preparaçion' }
  };
  ...
  function sourceName(source, snapshot){
    var data = source && source._mhData;
  ...
  function closestData(type, source, name){
    ...
    for(var i=0;i<points.length;i++){
      if(normalized(points[i].name) === wanted){ byName = points[i]; break; }
    }
  ...
  function modelFor(type, source, snapshot){
    ...
    if(point && point.name) name = String(point.name).replace(/\bAereoporto\b/gi, 'Aeroporto');
