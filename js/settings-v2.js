    ...
    it:{
      ...
      aboutSections:[
        ...
        {title:'Privacy e dati personali',paras:[
          ...
          'Quando viene utilizzato un account, possono essere associati all’utente dati relativi all’iscrizione e all’abbonamento, l’immagine del profilo, i Preferiti, i contenuti del Taccuino e lo stato dei punti QR visitati o non visitati.',
    ...
    en:{
      ...
      aboutSections:[
        ...
        {title:'Privacy and personal data',paras:[
          ...
          'When an account is used, data relating to registration and subscription, the profile image, Favourites, Notebook contents and the visited or not-visited status of QR points may be associated with the user.',
    ...
    es:{
      ...
      aboutSections:[
        ...
        {title:'Privacidad y datos personales',paras:[
          ...
          'Cuando se utiliza una cuenta, pueden asociarse al usuario datos relativos al registro y la suscripción, la imagen de perfil, los Favoritos, los contenidos del Cuaderno y el estado de los puntos QR visitados o no visitados.',
    ...
    fr:{
      ...
      aboutSections:[
        ...
        {title:'Confidentialité et données personnelles',paras:[
          ...
          'Lorsqu’un compte est utilisé, des données liées à l’inscription et à l’abonnement, l’image de profil, les Favoris, le contenu du Carnet et l’état visité ou non visité des points QR peuvent être associés à l’utilisateur.',
    ...
    ar:{
      ...
      aboutSections:[
        ...
        {title:'الخصوصية والبيانات الشخصية',paras:[
          ...
          'عند استخدام حساب، قد ترتبط بالمستخدم بيانات التسجيل والاشتراك وصورة الملف الشخصي والمفضلة ومحتويات دفتر الملاحظات وحالة نقاط QR التي تمت زيارتها أو لم تتم زيارتها.',
    ...
    ru:{
      ...
      aboutSections:[
        ...
        {title:'Конфиденциальность и персональные данные',paras:[
          ...
          'При использовании аккаунта с пользователем могут быть связаны данные о регистрации и подписке, изображение профиля, Избранное, содержимое Блокнота и статус посещённых или непосещённых QR-точек.',
    ...
    zh:{
      ...
      aboutSections:[
        ...
        {title:'隐私与个人数据',paras:[
          ...
          '使用账号时，与注册和订阅有关的数据、头像、收藏、记事本内容以及 QR 点的已访问/未访问状态可能会与用户关联。',
    ...
    lij:{
      ...
      aboutSections:[
        ...
        {title:'Privacy e dæti personali',paras:[
          ...
          'Quande se deuvia un account, peu ese associæ a l’utente dæti relativi a l’iscriçion e a l’abonamento, l’immagine do profilo, i Preferii, i contegnui do Taccuin e o stato di ponti QR visitæ ò no visitæ.',
