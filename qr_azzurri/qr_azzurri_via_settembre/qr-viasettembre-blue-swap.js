(function () {
  var data = {
    parent: { id:"viasettembre", label:"Via XX settembre", lat:44.40613883312987, lng:8.938713182664745 },
    children: [
      {
        id: "porta_archi",
        ...
        media: {
          ...
          ieri: [
            ...
            "qr_azzurri/qr_azzurri_via_settembre/porta_archi_ieri_2.mp4",
            "qr_azzurri/qr_azzurri_via_settembre/porta_archi_ieri_3.mp4",
            "qr_azzurri/qr_azzurri_via_settembre/porta_archi_ieri_4.mp4",
            "qr_azzurri/qr_azzurri_via_settembre/porta_archi_ieri_5.mp4"
          ]
        }
      },
      {
        ...
        media: {
          ...
          ieri: [
            ...
            "qr_azzurri/qr_azzurri_via_settembre/corso_podesta_ieri_2.mp4"
          ]
        }
      },
{
...

{
        ...
        media: {
          ...
          ieri: [
            ...
            "qr_azzurri/qr_azzurri_via_settembre/monumentale_ieri_2.mp4",
            "qr_azzurri/qr_azzurri_via_settembre/monumentale_ieri_3.mp4",
            "qr_azzurri/qr_azzurri_via_settembre/monumentale_ieri_4.mp4"
          ]
        }
      },
{
      ...
      },
{
        ...
        media: {
          ...
          ieri: [
            ...
            "qr_azzurri/qr_azzurri_via_settembre/viaxxviagalata_ieri_2.mp4", 
            "qr_azzurri/qr_azzurri_via_settembre/viaxxviagalata_ieri_3.mp4"
         ]
        }
      },
{
        id: "viaxx_piccapietra",
        ...
        media: {
          ...
          ieri: [
            ...
            "qr_azzurri/qr_azzurri_via_settembre/viaxxpiccapietra_ieri_2.mp4"
         ]
        }
      },

{
        ...
        media: {
          ...
          ieri: [
            ...
            "qr_azzurri/qr_azzurri_via_settembre/viaxx_alta_ieri_2.mp4"
          ]
        }
      },
{
  ...
  whenMapReady(function () {
    ...
    var chk = document.getElementById("chk-qr-viasettembre");
    if (!chk) return;

    if (!map.getPane("pane-viasettembre-blue")) {
      map.createPane("pane-viasettembre-blue");
      map.getPane("pane-viasettembre-blue").style.zIndex = 650;
    }
    if (!map.getPane("pane-viasettembre-azzurri")) {
      map.createPane("pane-viasettembre-azzurri");
      map.getPane("pane-viasettembre-azzurri").style.zIndex = 651;
    }
    ...
    blue.on("click", function () {
      if (window.__qrOpenChildPanel) {
        window.__qrOpenChildPanel(
          parent.label || "",
          "Zooma per vedere i punti di Via XX settembre.",
          { oggi: null, ieri: [] }
        );
      }
    });
    ...
    (kids || []).forEach(function (c, idx) {
      ...
      var m = L.marker([lat, lng], {
        pane: "pane-viasettembre-azzurri",
        icon: azzIcon,
        title: c.label
      });
    ...
    if (!chk.__wiredSwap_viasettembre) {
      chk.addEventListener("change", update);
      chk.__wiredSwap_viasettembre = true;
    }
